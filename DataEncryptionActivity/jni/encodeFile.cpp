...
extern "C" JNIEXPORT jint JNICALL Java_android_intel_sdp_DataEncryption_DataEncryptionOpenSSL_decodeFileFromJNI(JNIEnv* env, jobject obj, jstring jFilenameOut, jstring jFilenameIn ) {
	int ret = 0;
	const char* filenameIn = env->GetStringUTFChars( jFilenameIn, 0);
	const char* filenameOut = env->GetStringUTFChars( jFilenameOut, 0);
...
extern "C" JNIEXPORT void JNICALL Java_android_intel_sdp_DataEncryption_DataEncryptionOpenSSL_setBlocksizeFromJNI(JNIEnv* env, jobject obj, jint jBlocksizeIn ) {
